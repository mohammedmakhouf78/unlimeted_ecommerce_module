                ...
                <div class="widget mercado-widget filter-widget">
                    ...
                    <div class="widget-content">
                        ...
                        <div class="widget-banner">
                            <figure>
                                <img src="{{asset('endUserAssets/images/size-banner-widget.jpg')}}" width="270" height="331" alt="">
                            </figure>
                        </div>
                    </div>
                </div><!-- Size -->
                                ...
                                <div class="product product-widget-style">
                                    <div class="thumbnnail">
                                        <a href="detail.html"
                                            ...
                                            <figure><img src="{{asset('endUserAssets/images/products/digital_01.jpg')}}" alt="">
                                            </figure>
                                        </a>
                                    </div>
                            ...
                            <li class="product-item">
                                <div class="product product-widget-style">
                                    <div class="thumbnnail">
                                        <a href="detail.html"
                                            title="Radiant-360 R6 Wireless Omnidirectional Speaker [White]">
                                            <figure><img src="{{asset('endUserAssets/images/products/digital_17.jpg')}}" alt="">
                                            </figure>
                                        </a>
                                    </div>
                                    <div class="product-info">
                            ...
                            <li class="product-item">
                                <div class="product product-widget-style">
                                    <div class="thumbnnail">
                                        <a href="detail.html"
                                            title="Radiant-360 R6 Wireless Omnidirectional Speaker [White]">
                                            <figure><img src="{{asset('endUserAssets/images/products/digital_18.jpg')}}" alt="">
                                            </figure>
                                        </a>
                                    </div>
                                    <div class="product-info">
                            ...
                            <li class="product-item">
                                <div class="product product-widget-style">
                                    <div class="thumbnnail">
                                        <a href="detail.html"
                                            title="Radiant-360 R6 Wireless Omnidirectional Speaker [White]">
                                            <figure><img src="{{asset('endUserAssets/images/products/digital_20.jpg')}}" alt="">
                                            </figure>
                                        </a>
                                    </div>
                                    <div class="product-info">
