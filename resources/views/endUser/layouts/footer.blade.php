                        ...
                        <div class="wrap-footer-item">
                            ...
                            <div class="item-content">
                                <div class="wrap-list-item wrap-gallery">
                                    <img src="endUserAssets/images/payment.png" style="max-width: 260px;">
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="wrap-list-item apps-list">
                                    <ul>
                                        <li><a href="#" class="link-to-item"
                                                ...
                                                <figure><img src="endUserAssets/images/brands/apple-store.png"
                                                        alt="apple store" width="128" height="36">
                                                </figure>
                                            </a></li>
                                        <li><a href="#" class="link-to-item"
                                                title="our application on google play store">
                                                <figure><img src="endUserAssets/images/brands/google-play-store.png"
...
<script src="{{asset('endUserAssets/js/jquery-1.12.4.minb8ff.js?ver=1.12.4')}}"></script>

<script src="{{asset('endUserAssets/js/jquery-ui-1.12.4.minb8ff.js?ver=1.12.4')}}"></script>
<script src="{{asset('endUserAssets/js/bootstrap.min.js')}}"></script>
<script src="{{asset('endUserAssets/js/jquery.flexslider.js')}}"></script>
<script src="{{asset('endUserAssets/js/chosen.jquery.min.js')}}"></script>
<script src="{{asset('endUserAssets/js/owl.carousel.min.js')}}"></script>
<script src="{{asset('endUserAssets/js/jquery.countdown.min.js')}}"></script>
<script src="{{asset('endUserAssets/js/jquery.sticky.js')}}"></script>
<script src="{{asset('endUserAssets/js/functions.js')}}"></script>
